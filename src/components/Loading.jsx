...
export default function LoadingComponent({ loadingText, loadingIcon }) {
	return (
		<div className="inset-0 bg-white bg-opacity-90 backdrop-blur-sm flex flex-col items-center justify-center gap-6 z-50">
			...
			<div className="flex flex-col items-center gap-1">
				...
				<p className="text-gray-600 min-w-[5.5rem]">{loadingText}</p>
			</div>
		</div>
	);
}
