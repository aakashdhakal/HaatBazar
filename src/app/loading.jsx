...
export default function Loading() {
	...
	return (
		<div className="fixed inset-0 bg-background bg-opacity-90 backdrop-blur-sm flex flex-col items-center justify-center z-50">
			...
			<div className="mt-6 text-center">
				...
				<p className="text-muted-foreground min-w-[5.5rem] text-center">
					{loadingText}
				</p>
			</div>
		</div>
